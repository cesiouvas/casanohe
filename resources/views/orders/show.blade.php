...
<div class="pt-4" style="display:flex; justify-content:center; align-items:center;">
    <div class="rounded-5 p-2" style="border: 8px solid #ffcc23; background-color: #fcf386; width: 80vh;">
        ...
        <h1>Pedido de {{$user->name}} {{$user->surname}}</h1>
        <p>Vista detallada del pedido #{{ $order->id }}</p>
        ...
        <div class="p-2 bg-light">
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4"><b>Costes totales</b></div>
            </div>
            ...
            <div class="row">
                ...
                @for ($i = 0; $i < $line->line_quantity; $i++)
                    ...
                    <div class="col-6 col-md-4">
                        <img src="{{ asset('img/' . $line->image . '.png') }}" alt="{{ $line->image }}" width="50px">
                        {{ $line->name }}
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8"><b>Precio total</b></div>
                <div class="col-6 col-md-4">
